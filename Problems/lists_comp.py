...
answer_list = [ "You can count on it", "My reply is no", "My sources say no", "Outlook not so good", "Very doubtful" ]
...
your_tickets = [[random.randrange(10) for x in range(4)] for y in range(10000)]
